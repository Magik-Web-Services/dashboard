                                ...
                                <form>
                                    <div class=" ">
                                        ...
                                        <div class="form-group">
                                            <div class="row"><label class="col-form-label col-lg-2 col-form-label">Quote#</label>
                                                <div class="col-lg-4"><input name="Quote" value="QT-000001" class="ember-text-field ember-view form-control" type="text"></div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row"><label class="col-form-label col-lg-2 col-form-label">Reference#</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row"><label class="col-form-label col-lg-2 col-form-label required">Quote Date</label>
                                                <div class="col-lg-4"> <input placeholder="dd/MM/yyyy" class="ember-text-field zf-date-picker date-picker ember-view form-control" type="date">
                                                </div> <label class="col-lg-2 col-form-label">Expiry Date</label>
                                                <div class="col-lg-4"><input placeholder="dd/MM/yyyy" class="ember-text-field zf-date-picker date-picker ember-view form-control" type="date">
                                                    <div class="text-danger d-none">Expiry Date should be after Quote Date</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row"><label class="col-form-label col-form-label col-lg-2">Project Name</label>
                                                <div class="col-lg-4 ">
                                                    <div class="ember-view">
                                                        <div class="ac-box "><span class="ac-selected form-control disabled" tabindex="0"> <span class="placeholder-text mr-0">Select a project</span>
                                                                <div class="ac-toggle-container"><i class="zf-ac-toggler"></i></div>
                                                            </span></div>
                                                    </div>
                                                    <p class="font-xs">Select a customer to associate a project.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row"></div>
                                    ...
                                    <div class="zb-txn-form">
                                        ...
                                        <table class="line-item-table line-item-table-light" id="addlineData">
                                            ...
                                            <tbody id="Beforetr" class="ember-view line-item-body invoice-nodiscount">
                                                <tr class="ember-view line-item new-line-item line-item-us">
                                                    ...
                                                    <td class="borderb line-item-column item-qty ember-view">
                                                        <div class="height65"><input value="1.00" class="border0 ember-text-field text-right ember-view form-control qty-field " type="text">
                                                            <div class="ember-view">
                                        ...
                                        <div class="row flex-column">
                                            <div class="add-line-item col-lg-5 d-flex flex-column mt-3">
                                                <div class="dropdown  Additem ember-view btn-group line-seperator align-self-start add-line-item-btn"><span id="Addline" class="btn btn-md"> <i class="fa-solid fa-circle-plus" style="color: #188dfa;"></i> Add another line</span> <span class="pr-2 dropdown-toggle ember-view add-line-item-separator"></span>
                                                    ...
                                                    <div class="ember-view">
                                                        ...
                                                        <div class="table-row">
                                                            <div class="total-row grid3row mb-2">
                                                                <div class="badge-editable total-label">
                                                                    <div class="grid2row">
                                                                        <div class="mr-3 col-lg-20"><inputclass="ember-text-field ember-view form-control editable" type="text"></div>
                                                                        <div class="col-lg-20"><input class="ember-text-field text-right ember-view form-control" type="text"></div> <i class="popover-help-trigger"></i>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="table-row" id="tcs-field">
                                                            <div class="grid3row">
                                                                <div class="total-label">
                                                                    <div class="grid2row">
                                                                        <div class="col-lg-5 col-sm-5 col-5 py-2 pl-0">
                                                                            <div class="form-control-plaintext">TCS </div>
                                                                        </div>
                                    ...
                                    <div class="zb-txn-form">
                                        <div class="btn-toolbar pb-5 mb-5 fixed-actions fill-container">
                                            <div class="dropdown ember-view btn-group"><button class="mr-2 btn btn-primary ember-view" type="submit"> Send</button> </div>
                                        </div>
                                    </div>
                            </div>
                            </form>
